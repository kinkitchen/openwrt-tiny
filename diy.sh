...
curl -fsSL https://raw.githubusercontent.com/cgistar/openwrt-tiny/main/sub/bin/sub-openwrt-x86_64.tar.gz | tar -zxC files/usr/share/sub && chmod +x files/usr/share/sub/sub
